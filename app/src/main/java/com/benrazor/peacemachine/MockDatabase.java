...
public final class MockDatabase {
    ...
    public static class BigTextStyleReminderAppData extends MockNotificationData {
        ...
        private BigTextStyleReminderAppData() {
            ...
            mContentTitle = "Peace Machine";
            // Content for API <24 (4.0 and below) devices.
            mContentText = "Making peaceful sounds";
            mPriority = NotificationCompat.PRIORITY_DEFAULT;

            // BigText Style Notification values:
            mBigContentTitle = "Peace Machine (big)";
            mBigText = "Making peaceful sounds (big)";
            mSummaryText = "Peace summary";

            // Notification channel values (for devices targeting 26 and above):
            mChannelId = "channel_peacemachine_1";
            // The user-visible name of the channel.
            mChannelName = "Peace Machine Channel";
            // The user-visible description of the channel.
            mChannelDescription = "Channel for peace machine notifications";
